...
@_coconut_mark_as_match  #10 (line in Coconut source)
def _coconut_lambda_0(_coconut_match_first_arg=_coconut_sentinel, *_coconut_match_args, **_coconut_match_kwargs):  #10 (line in Coconut source)
    ...
    if _coconut_match_first_arg is not _coconut_sentinel:  #10 (line in Coconut source)
        _coconut_match_args = (_coconut_match_first_arg,) + _coconut_match_args  #10 (line in Coconut source)
