...
def denumpy_all(obj):  #54 (line in Coconut source)
    ...
    if isinstance(obj, (list, tuple)):  #56 (line in Coconut source)
        ...
        return dict(((denumpy_all(k)), (denumpy_all(v))) for k, v in obj.items())  #59 (line in Coconut source)
...
def json_serialize(obj):  #69 (line in Coconut source)
    ...
    if isinstance(obj, Mapping):  #75 (line in Coconut source)
        serialized_dict = {}  #76 (line in Coconut source)
...
def best_example(examples):  #129 (line in Coconut source)
    ...
    if best:  #132 (line in Coconut source)
        ...
        return {"values": {}}  #136 (line in Coconut source)
...
def mean(*_coconut_match_args, **_coconut_match_kwargs):  #301 (line in Coconut source)
...
@_coconut_addpattern(mean)  #304 (line in Coconut source)
@_coconut_mark_as_match  #304 (line in Coconut source)
def mean(*_coconut_match_args, **_coconut_match_kwargs):  #304 (line in Coconut source)
