    ...
    def register(self, name, value, replace=False):
        ...
        if not replace:
            ...
            if _coconut.isinstance(_coconut_match_to_1, _coconut.abc.Mapping):
                _coconut_match_temp_1 = _coconut_match_to_1.get(name, _coconut_sentinel)
                if _coconut_match_temp_1 is not _coconut_sentinel:
                    _coconut_match_set_name_stored_val = _coconut_match_temp_1
                    _coconut_match_check_1 = True
            if _coconut_match_check_1:
                if _coconut_match_set_name_stored_val is not _coconut_sentinel:
                    stored_val = _coconut_match_set_name_stored_val
            if _coconut_match_check_1:
                if stored_val == value:
                    return
                else:
    ...
    def register_alias(self, name, alias, replace=False):
        ...
        if not replace:
            ...
            if _coconut.isinstance(_coconut_match_to_2, _coconut.abc.Mapping):
                _coconut_match_temp_2 = _coconut_match_to_2.get(name, _coconut_sentinel)
                if _coconut_match_temp_2 is not _coconut_sentinel:
                    _coconut_match_set_name_stored_alias = _coconut_match_temp_2
                    _coconut_match_check_2 = True
            if _coconut_match_check_2:
                if _coconut_match_set_name_stored_alias is not _coconut_sentinel:
                    stored_alias = _coconut_match_set_name_stored_alias
            if _coconut_match_check_2:
