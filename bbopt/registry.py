...
class Registry(_coconut.object):  #7 (line in Coconut source)
    ...
    def __init__(self, obj_name, defaults=None, generators=None, aliases=None):  #10 (line in Coconut source)
        ...
        self.registered = ({} if defaults is None else defaults)  #12 (line in Coconut source)
        self.generators = ({} if generators is None else generators)  #13 (line in Coconut source)
        self.aliases = ({} if aliases is None else aliases)  #14 (line in Coconut source)
